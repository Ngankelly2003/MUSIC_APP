                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return GestureDetector(
                        onTap: () {
                          ...
                          audioVM.currentSong =
                              audioVM.mostPopular[audioVM.selectedIndex];
                      ...
                      children: [
                        Row(
                          children: [
                            Hero(
                              ...
                              child: CircleAvatar(
                                backgroundImage:
                                    AssetImage(audioVM.currentSong.image),
                                radius: 30,
                              ),
                            ),
                            SizedBox(
                        ...
                        Row(
                          children: [
                            GestureDetector(
                              onTap: () {
                                if (audioVM.isPlaying == true) {
                                  ...
                                  audioVM.pause();
                                } else if (audioVM.isPlaying == false) {
                                  audioVM.isPlaying = true;
                                  audioVM.resume();
                                  Timer.periodic(Duration(seconds: 1), (timer) {
                                    if (audioVM.currentSlider <
                                        audioVM.currentSong.duration) {
                                ...
                                } else if (audioVM.isPlaying == null) {
                                  audioVM.isPlaying = true;
                                  audioVM.play();
                                  Timer.periodic(Duration(seconds: 1), (timer) {
                                    if (audioVM.currentSlider <
                            ...
                            GestureDetector(
                              onTap: () {
                                audioVM.selectedIndex =
                                    (audioVM.selectedIndex + 1) %
                                        audioVM.mostPopular.length;
                                audioVM.currentSong =
                                    audioVM.mostPopular[audioVM.selectedIndex];
                                audioVM.play();
